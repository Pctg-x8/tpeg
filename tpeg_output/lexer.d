...
{
	__SKIP_PATTERN__, INUMBER, HNUMBER, FNUMBER, DNUMBER, NUMBER, DNUMBER2, NUMBER2, 
	STRING, CHARACTER, IDENTIFIER, SEMICOLON, PERIOD, COMMA, COLON, RARROW, RARROW2, 
	LARROW, SHARP, EQUAL, PLUS_EQ, MINUS_EQ, ASTERISK_EQ, SLASH_EQ, PERCENT_EQ, 
	AMPASAND_EQ, VL_EQ, CA_EQ, LAB2_EQ, RAB2_EQ, AMPASAND2, VL2, CA2, PLUS, MINUS, 
	ASTERISK, SLASH, PERCENT, AMPASAND, VL, CA, LAB2, RAB2, LAB, RAB, LAB_EQ, RAB_EQ, 
	EQ2, EX_EQ, QUESTION, PLUS2, MINUS2, ASTERISK2, PERIOD2, PERIOD3, LP, RP, LB, 
	RB, LBR, RBR, PACKAGE, IMPORT, CLASS, TRAIT, ENUM, EXTENDS, WITH, TEMPLATE, 
	ALIAS, USING, PROPERTY, FUNCTION, IF, ELSE, WHILE, DO, FOREACH, FOR, RETURN, 
	BREAK, CONTINUE, SWITCH, CASE, DEFAULT, TYPEOF, THIS, SUPER, TRUE, FALSE, NULL, 
	PUBLIC, PRIVATE, PROTECTED, FINAL, CONST, STATIC, OVERRIDE, AUTO, VOID, CHAR, 
	UCHAR, BYTE, SHORT, USHORT, INT, UINT, LONG, ULONG, __INPUT_END__
}
